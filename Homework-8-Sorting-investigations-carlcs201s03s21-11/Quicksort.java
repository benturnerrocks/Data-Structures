...
public class Quicksort {
    ...
    public static void main(String[] args) {
        ...
        int[] quicksortArray = new int[9800];
        int numRuns = 50;

        List<PivotSelector> selectors = Arrays.asList(new FirstIndexPivotSelector(), new RandomPivotSelector(), new AveragePivotSelector(), new MedianOf3PivotSelector());

        List<String> names = Arrays.asList("First index", "Random index", "Average Value index", "Median Of 3 index");
